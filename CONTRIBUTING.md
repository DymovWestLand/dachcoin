Contributing to Dachcoin Core
==================================

The Dachcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dachcoin Core project, and is not to be
confused with overall Dachcoin Network Protocol consensus changes.

Whether a pull request is merged into Dachcoin Core rests with the project merge
...
Patches that change Dachcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dachcoin consensus, it must have been
...
The project leader is the release manager for each Dachcoin Core release.
