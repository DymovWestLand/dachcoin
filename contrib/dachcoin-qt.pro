...
RESOURCES += src/qt/dachcoin.qrc src/qt/dachcoin_locale.qrc

TRANSLATIONS += src/qt/locale/dachcoin_bg.ts \
                src/qt/locale/dachcoin_de.ts \
                src/qt/locale/dachcoin_en.ts \
                src/qt/locale/dachcoin_es.ts \
                src/qt/locale/dachcoin_fi.ts \
                src/qt/locale/dachcoin_fr.ts \
                src/qt/locale/dachcoin_it.ts \
                src/qt/locale/dachcoin_ja.ts \
                src/qt/locale/dachcoin_pl.ts \
                src/qt/locale/dachcoin_pt.ts \
                src/qt/locale/dachcoin_ru.ts \
                src/qt/locale/dachcoin_sk.ts \
                src/qt/locale/dachcoin_sv.ts \
                src/qt/locale/dachcoin_vi.ts \
                src/qt/locale/dachcoin_zh_CN.ts \
                src/qt/locale/dachcoin_zh_TW.ts
