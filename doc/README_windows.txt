...
Intro
-----
Dachcoin (DACH) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Dachcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dachcoin-qt.exe.

Dachcoin Core is the original Dachcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Dachcoin transactions;
