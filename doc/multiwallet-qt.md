...
In order to support loading of multiple wallets in dachcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dachcoin.cpp.
...
Changes to dachcoin.cpp
----------------------
dachcoin.cpp is the entry point into dachcoin-qt, and as such, will require some minor modifications to provide hooks for
