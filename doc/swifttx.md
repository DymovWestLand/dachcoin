...
This mechanism has been integrated into Bitcore-Node-Dachcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dachcoin/insight-api-dachcoin#web-socket-api](https://github.com/dachcoin/insight-api-dachcoin#web-socket-api)
* API: [https://github.com/dachcoin/insight-api-dachcoin#swifttx-transactions](https://github.com/dachcoin/insight-api-dachcoin#swifttx-transactions)
...
By default, the Dachcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dachcoin Core daemon:
