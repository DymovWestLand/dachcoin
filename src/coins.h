...
/** 
    ...
    ****Note - for Dachcoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of dachcoin coming in to a transaction
