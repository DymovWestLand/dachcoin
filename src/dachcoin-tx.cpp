...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dachcoin Core dachcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dachcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dachcoin transaction") + "\n" +
                               "  dachcoin-tx [options] -create [commands]   " + _("Create hex-encoded dachcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dachcoin transaction
