...
#if defined(NDEBUG)
#error "Dachcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in udach) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) {
        ...
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 40400 && nHeight > 25000) {
        nSubsidy = 35 * COIN;
	} else if (nHeight <= 66200 && nHeight > 40400) {
        nSubsidy = 50 * COIN;
	} else if (nHeight <= 98900 && nHeight > 66200) {
        nSubsidy = 60 * COIN;
	} else if (nHeight <= 136800 && nHeight > 98900) {
        nSubsidy = 70 * COIN;
	} else if (nHeight <= 156800 && nHeight > 136800) {
        nSubsidy = 40 * COIN;
	} else if (nHeight <= 250000 && nHeight > 156800) {
        nSubsidy = 30 * COIN;
    } else {
        nSubsidy = 20 * COIN;
    }
...
{
    RenameThread("dachcoin-scriptch");
