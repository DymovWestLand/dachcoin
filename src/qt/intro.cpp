...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dachcoin Core"),
     ...
     * override -datadir in the dachcoin.conf file in the default data directory
     * (to be consistent with dachcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
