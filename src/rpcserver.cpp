...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dachcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dachcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dachcoin features */
        {"dachcoin", "masternode", &masternode, true, true, false},
        {"dachcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"dachcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dachcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dachcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dachcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"dachcoin", "startmasternode", &startmasternode, true, true, false},
        {"dachcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dachcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dachcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dachcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dachcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dachcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dachcoin", "mnbudget", &mnbudget, true, true, false},
        {"dachcoin", "preparebudget", &preparebudget, true, true, false},
        {"dachcoin", "submitbudget", &submitbudget, true, true, false},
        {"dachcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dachcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dachcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dachcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dachcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dachcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dachcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dachcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"dachcoin", "mnsync", &mnsync, true, true, false},
        {"dachcoin", "spork", &spork, true, true, false},
        {"dachcoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"dachcoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"dachcoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"dachcoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"dachcoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"dachcoin", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> dachcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31602/\n";
}
